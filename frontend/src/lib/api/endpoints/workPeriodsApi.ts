    ...
    getWorkPeriodSalesSummary: builder.query<any, string>({
      ...
      transformResponse: (response: any) => {
        ...
        return {
          ...
          manualIncomeTotal: data?.manualIncomeTotal || 0,
          manualExpenseTotal: data?.manualExpenseTotal || 0,
          purchaseTotal: data?.purchaseTotal || 0,
          exchangeIncomeTotal: data?.exchangeIncomeTotal || 0,
          exchangeRefundTotal: data?.exchangeRefundTotal || 0,
